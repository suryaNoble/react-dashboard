...
export const user = { name: "Noble" };
export const dashboardStats = {
  totalUsers: 7890,
  usersJoined: { currentMonth: 120, lastMonth: 100 },
  totalTrips: 4567,
  tripsCreated: { currentMonth: 300, lastMonth: 250 },
  userRole: { total: 69, currentMonth: 10, lastMonth: 59 },
};
